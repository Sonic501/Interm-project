...
import lastPageSvg from '../../ViewSyllabusList/assets/last_page.svg';
import arrowBackSvg from '../../ViewSyllabusList/assets/arrow_back_ios.svg';
import arrowForwardSvg from '../../ViewSyllabusList/assets/arrow_forward_ios.svg';
...
const Pagination = (props) => {
  ...
  const activeClass = "mx-1 flex h-9 w-9 items-center justify-center rounded-full bg-[#285D9A] p-0 text-lg font-bold transition duration-150 ease-in-out text-white button-active";
  const inactiveClass = "mx-1 flex h-9 w-9 items-center justify-center rounded-full bg-[#E2E8F0] p-0 text-lg font-bold transition duration-150 ease-in-out text-blue-900";
