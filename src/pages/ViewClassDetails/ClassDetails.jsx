...
const ViewClassDetails = () => {
  ...
  const user = useSelector(
    (state) => state.trainingClassTrainer.trainingTrainerClassdata
  );
  ...
  // loading truoc
  useEffect(() => {
    dispatch(fetchTrainingClassDataDetail({ id,token }));
    dispatch(fetchTrainerTrainingClass({ id, token }));
    dispatch(fetchTrainingProgram({ id, token }));
    dispatch(fetchAdminTraining({ id, token })); 
    dispatch(fetchTrainingListProgram({token}))
  }, []);
  ...
  return (
    <>
      ...
      <div className="mt-[30px] ml-[20px] w-full">
                ...
                case "tab1":
                  return (
                    <div className="flex flex-col gap-[10px] mt-[2px]  ">
                      ...
                      <div className="flex flex-wrap my-3 w-[1137px] ">
                        {listProgram?.map((program) => (
                          <>
                            <div className="w-1/5  flex  bg-[#2D3748] h-[96px] py-4 px-4 space-x-3 rounded-l-3xl items-center ">
                              <img
                            ...
                            <div className="bg-white py-4 pt-3 w-4/5 h-[96px] mb-6">
                              <div className="bg-white rounded-r-3xl py-4 pt-3 px-6 w-full shadow-lg rounded-[4px]">
