...
const ViewClassDetails = () => {
  ...
  useEffect(() => {
    ...
    dispatch(fetchAdminTraining({ id }));
  }, []);
              ...
              >
                ...
                <div className="grid grid-cols-1 px-6 py-3">
                  <dt className="font-bold">
                    ...
                    <i className="  text-2xl text-[#285D9A] mr-1" /> Trainer{" "}
                    {user?.map((userName) => (
            ...
            {(() => {
              switch (activeTab) {
                ...
                case "tab2":
                  return (
                    <div>
                      <div className="bg-[#203748] px-8 py-2 text-white rounded-tr-3xl">
                        <h1 className="text-3xl tracking-widest font-bold mb-3">
                          Tab2
                        </h1>
                        <div className="flex">
                          31 days &nbsp;&nbsp;|&nbsp;&nbsp;
                          <p>
                            Modified on
                            <span className="italic">22/01/2001</span>
                            &nbsp;by
                            <span className="font-bold">Warrior Tran</span>
                          </p>
                        </div>
                      </div>
                      <div className="bg-white rounded-r-3xl py-4 px-6 w-4/5 shadow-md">
                        ...
                        <div className="block">
                          Demo3 demo4 &nbsp;&nbsp;|&nbsp;&nbsp; 31 days (
                          <span className="italic">DEmo5</span> hours)
                          &nbsp;&nbsp;|&nbsp;&nbsp; on{" "}
                          <span className="italic">22/01/2001 </span> by
                          SomeoneImportant
                        </div>
                      </div>
                    </div>
