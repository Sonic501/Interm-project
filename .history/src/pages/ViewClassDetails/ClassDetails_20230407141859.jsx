          ...
          <div className="outlet">
            {(() => {
              switch (activeTab) {
                case "tab1":
                  return (
                    <div className="flex flex-col gap-[10px] mt-[2px] w-full ">
                      <div className="w-full my-2 h-[86px] p-[10px_30px_20px_30px] bg-[#2D3748] rounded-[0px_20px_0px_0px]">
                      ...
                      {listProgram?.map((program) => (
                        ...
                        <div className="bg-white  rounded-r-3xl py-4 px-6 w-4/5 shadow-md">
                            <div className="bg-white rounded-r-3xl py-4 px-6 w-full shadow-md">
                            <div>
