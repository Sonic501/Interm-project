        ...
        <div className="Tabs flex flex-col">
          <ul className="nav flex w-[700px]">
            <li
              className={
                activeTab == "tab1"
                  ? "cursor-pointer z-10 text-center   w-[200px]  h-[30px]  bg-[#2D3748] "
                  : "cursor-pointer z-10 text-center   w-[200px]  h-[30px] bg-[#6D7684] "
              }
              onClick={handleTab1}
            >
              Training Program
          ...
          <div className="outlet">
            {(() => {
              switch (activeTab) {
                case "tab1":
                  return (
                    <div className="flex flex-col gap-[20px] mt-[2px] w-full ">
