                ...
                case "tab1":
                  return (
                    <div className="flex flex-col gap-[20px] mt-[2px] w-full ">
                      ...
                      <div className="flex flex-wrap my-3 w-4/5">
                      {listProgram?.map((program) => (
                        <>
                        <div className="w-1/4 flex  bg-[#2D3748] h-[96px] py-4 px-4 space-x-3 rounded-l-3xl items-center ">
                          <img
                        ...
                        <div className="bg-white  rounded-r-3xl py-4 px-6 w-2/5 shadow-md">
